...
mods.forestry.ThermionicFabricator.addCast(<opencomputers:material:2>, [[<rockhounding_chemistry:alloy_items_tech:27>, <ore:blockDiamond>, <ore:ingotGold>], [<ore:blockRedstone>, <ore:blockRedstone>, <ore:blockRedstone>]], <liquid: glass> * 10, <opencomputers:material:9>);
