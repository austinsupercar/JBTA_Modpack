...
RecipeBuilder.get("engineer")
  .setShaped([
    [<ore:plateSteel>, <ore:ingotSteel>, <ore:ingotSteel>, <ore:ingotSteel>, <ore:plateSteel>],
    [<ore:ingotSteel>, <ore:ingotSteel>, <extendedcrafting:material>, <ore:ingotSteel>, <ore:ingotSteel>],
    [<ore:ingotSteel>, <minecraft:chest>, <forestry:hardened_machine>, <minecraft:chest>, <ore:ingotSteel>],
    [<ore:ingotSteel>, <ore:ingotSteel>, <extendedcrafting:material>, <ore:ingotSteel>, <ore:ingotSteel>],
    [<ore:plateSteel>, <ore:ingotSteel>, <ore:ingotSteel>, <ore:ingotSteel>, <ore:plateSteel>]])
  .addOutput(<storagenetwork:master>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:crafting_table>, <storagenetwork:master>])
  .addOutput(<storagenetwork:request>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:chest>, <storagenetwork:master>])
  .addOutput(<storagenetwork:inventory>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<buildcrafttransport:pipe_gold_item>, <storagenetwork:master>])
  .addOutput(<storagenetwork:kabel> * 32)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:diamond_block>, <storagenetwork:kabel>])
  .addOutput(<storagenetwork:simple_kabel>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:obsidian>, <storagenetwork:kabel>])
  .addOutput(<storagenetwork:storage_kabel>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:emerald_block>, <storagenetwork:kabel>])
  .addOutput(<storagenetwork:ex_kabel>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:redstone_block>, <storagenetwork:kabel>])
  .addOutput(<storagenetwork:im_kabel>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:gold_block>, <storagenetwork:kabel>])
  .addOutput(<storagenetwork:process_kabel>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<storagenetwork:process_kabel>, <storagenetwork:process_kabel>, <storagenetwork:master>, <storagenetwork:process_kabel>, <storagenetwork:process_kabel>])
  .addOutput(<storagenetwork:controller>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<contenttweaker:super_diamond>, <contenttweaker:super_diamond>, <storagenetwork:master>, <contenttweaker:super_diamond>, <contenttweaker:super_diamond>])
  .addOutput(<storagenetwork:upgrade>)
  .create();
  
RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:redstone_torch>, <storagenetwork:upgrade>])
  .addOutput(<storagenetwork:upgrade:1>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:glowstone_dust>, <storagenetwork:upgrade>])
  .addOutput(<storagenetwork:upgrade:2>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:chest>, <storagenetwork:upgrade>])
  .addOutput(<storagenetwork:upgrade:3>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<storagenetwork:controller>, <storagenetwork:upgrade>])
  .addOutput(<storagenetwork:remote>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:diamond_block>, <storagenetwork:remote>])
  .addOutput(<storagenetwork:remote:1>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:gold_block>, <storagenetwork:remote>])
  .addOutput(<storagenetwork:remote:2>)
  .create();

RecipeBuilder.get("engineer")
  .setShapeless([<minecraft:emerald_block>, <storagenetwork:remote>])
  .addOutput(<storagenetwork:remote:3>)
  .create();
...
RecipeBuilder.get("engineer")
  .setShaped([
    ...
    [<ore:plateSteel>, <ore:plateSteel>, <storagenetwork:remote>, <ore:plateSteel>, <ore:plateSteel>],
    [null, <ore:plateSteel>, <avaritia:resource:1>, <ore:plateSteel>, null],
    [null, <ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>, null]])
  .addOutput(<storagenetwork:picker_remote>)
  .create();

RecipeBuilder.get("engineer")
  .setShaped([
    [<contenttweaker:super_diamond>, <avaritia:resource:1>, <contenttweaker:super_diamond>],
    [<contenttweaker:super_diamond>, <storagenetwork:remote>, <contenttweaker:super_diamond>],
    [<contenttweaker:super_diamond>, <minecraft:hopper>, <contenttweaker:super_diamond>]])
  .addOutput(<storagenetwork:collector_remote>)
  .create();