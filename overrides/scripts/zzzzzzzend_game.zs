...
mods.forestry.ThermionicFabricator.addCast(<contenttweaker:red_compound_ingot> * 64, [[<advancedrocketry:crystal:*>, <advancedrocketry:geode>, <advancedrocketry:crystal:*>], [<advancedrocketry:geode>, <advancedrocketry:crystal:*>, <advancedrocketry:geode>], [<advancedrocketry:crystal:*>, <advancedrocketry:geode>, <advancedrocketry:crystal:*>]], <liquid: glass> * 10, <thermalfoundation:material:513>);
mods.forestry.ThermionicFabricator.addCast(<contenttweaker:sign_f> * 5, [[<contenttweaker:red_compound_ingot>, <advancedrocketry:geode>, <contenttweaker:red_compound_ingot>], [<advancedrocketry:geode>, <alchemistry:ingot:92>, <advancedrocketry:geode>], [<contenttweaker:red_compound_ingot>, <advancedrocketry:geode>, <contenttweaker:red_compound_ingot>]], <liquid: glass> * 10, <thermalfoundation:material:513>);
